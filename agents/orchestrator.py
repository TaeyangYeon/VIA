                ...
                if restart_from == "spec_agent":
                    ...
                    try:
                        ...
                        raise AgentExecutionError(
                            str(exc), agent_name="spec_agent", error_code="SPEC_AGENT_ERROR"
                        ) from exc
    ...
    async def _run_from_stage(
            ...
            try:
                ...
                return (
                    ...
                    EvaluationResult(
                        ...
                        failure_reason=FailureReason.inspection_plan_issue,
                        failed_items=[],
                        analysis=f"검사 계획 생성 실패: {exc}",
                    ),
                )
        ...
        if mode == InspectionMode.inspection:
            ...
            try:
                ...
                self._log("ERROR", f"Algorithm coder (align) 실패: {exc}")
                return (
                    candidates, best_pipeline, best_judge, inspection_plan, algorithm_category,
                    None, None, [],
                    EvaluationResult(
